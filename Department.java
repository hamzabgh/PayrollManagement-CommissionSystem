...
public class Department 
{
    ...
    public void print_all_details()
    {
        for(int i =0; i<emplist.size(); i++)
        {
            if(emplist.get(i) instanceof SalarieEmployee)
                ((SalarieEmployee)emplist.get(i)).Displayalldetails();
            if(emplist.get(i) instanceof HourlyEmpoloyee)
                ((HourlyEmpoloyee)emplist.get(i)).Displayalldetails();
